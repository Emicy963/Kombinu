...
class GlobalRankingView(APIView):
    ...
    def get(self, request):
        ...
        user_scores = QuizSubmission.objects.values("user_id").annotate(
        ...
        current_user_score_entry = next((item for item in user_scores if item["user_id"] == current_user_id), None)
        currente_user_total_score = current_user_score_entry["total_score"] if current_user_score_entry else 0
